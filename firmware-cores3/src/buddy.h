...
// Render target type — LovyanGFX is the common base shared by both
// M5Canvas (the off-screen sprite) and M5GFX (the live LCD), so the
// buddy renderer can target either.
